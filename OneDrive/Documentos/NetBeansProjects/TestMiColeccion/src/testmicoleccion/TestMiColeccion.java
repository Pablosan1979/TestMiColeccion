...
public class TestMiColeccion {
    ...
    public static void main(String arg[]) {
        System.out.println("MiColeccion 1"); MiColeccion mc1 = new MiColeccion();
        ...
        System.out.println("El numero 2 esta "+mc1.cuentaRepeticiones(2) + "veces"); mc1.reemplazarValor(0, 9);
        mc1.mostrarContenido(); mc1.reemplazarTodo(al);mc1.mostrarContenido();
        //System.out.println(mc1.invertir());+boolean esPalindrome() + boolean buscar(int numero)+ void mostrarContenido(); 
        System.out.println("El mayor elemento es: "+mc1.getMayor());
        System.out.println("El menor elemento es: "+mc1.getMenor()); mc1.insertarAlFinal(1);
